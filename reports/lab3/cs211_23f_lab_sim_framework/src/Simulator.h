...
public:
  ...
  const int testArrayNumber = 5;
  const int testArrayAddress = 0x80000300;
  ...
  void storeHandlerCodes();
  bool ifExecutingHandler;
  bool ifExecutingSret;
  uint64_t pc_preserve;
  uint64_t reg_preserve[RISCV::REGNUM];
#endif
